...
namespace Late.Model
{
    ...
    public partial class CreateCommentAutomation200ResponseAutomation : IValidatableObject
    {
        ...
        public CreateCommentAutomation200ResponseAutomation(string id = default, string name = default, string platform = default, string platformPostId = default, List<string> keywords = default, MatchModeEnum? matchMode = default, string dmMessage = default, string commentReply = default, bool isActive = default, CreateCommentAutomation200ResponseAutomationStats stats = default, DateTime createdAt = default)
        {
            this.Id = id;
            this.Name = name;
