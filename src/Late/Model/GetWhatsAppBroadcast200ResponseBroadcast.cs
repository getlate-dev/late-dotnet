...
namespace Late.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getWhatsAppBroadcast_200_response_broadcast")]
    public partial class GetWhatsAppBroadcast200ResponseBroadcast : IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWhatsAppBroadcast200ResponseBroadcast" /> class.
        /// </summary>
        ...
        public GetWhatsAppBroadcast200ResponseBroadcast(string id = default, string name = default, string description = default, Object template = default, StatusEnum? status = default, int recipientCount = default, DateTime scheduledAt = default, DateTime startedAt = default, DateTime completedAt = default, int sentCount = default, int deliveredCount = default, int readCount = default, int failedCount = default, DateTime createdAt = default, DateTime updatedAt = default)
        {
            this.Id = id;
            this.Name = name;
