...
namespace Late.Model
{
    ...
    public partial class Message : IValidatableObject
    {
        ...
        public Message(string id = default, string conversationId = default, PlatformEnum platform = default, string platformMessageId = default, DirectionEnum direction = default, string text = default, List<WebhookPayloadMessageMessageAttachmentsInner> attachments = default, WebhookPayloadMessageMessageSender sender = default, DateTime sentAt = default, bool isRead = default)
        {
            ...
            {
                throw new ArgumentNullException("conversationId is a required property for Message and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("platformMessageId is a required property for Message and cannot be null");
            }
            ...
            if (text == null)
            {
                throw new ArgumentNullException("text is a required property for Message and cannot be null");
            }
            this.Text = text;
