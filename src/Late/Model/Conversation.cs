...
namespace Late.Model
{
    ...
    public partial class Conversation : IValidatableObject
    {
        ...
        public Conversation(string id = default, string platformConversationId = default, string participantId = default, string participantName = default, string participantUsername = default, string participantPicture = default, StatusEnum status = default)
        {
