...
namespace Late.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostLog")]
    public partial class PostLog : IValidatableObject
    {
        /// <summary>
        /// Defines Platform
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostLog" /> class.
        /// </summary>
        ...
        public PostLog(string id = default, PostLogPostId postId = default, string userId = default, string profileId = default, PlatformEnum? platform = default, string accountId = default, string accountUsername = default, ActionEnum? action = default, StatusEnum? status = default, int statusCode = default, string endpoint = default, PostLogRequest request = default, PostLogResponse response = default, int durationMs = default, int attemptNumber = default, DateTime createdAt = default)
        {
            this.Id = id;
            this.PostId = postId;
            this.UserId = userId;
        ...
        public PostLogPostId PostId { get; set; }
