...
namespace Late.Api
{
    ...
    public partial class PostsApi : IDisposable, IPostsApi
    {
        ...
        /// <summary>
        /// Delete post Delete a draft or scheduled post from Late. Published posts cannot be deleted; use the Unpublish endpoint instead. Upload quota is automatically refunded.
        /// </summary>
        /// <exception cref="Late.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="postId"></param>
        /// <returns>PostDeleteResponse</returns>
        ...
        /// <summary>
        /// Unpublish post Deletes a published post from the specified platform. The post record in Late is kept but its status is updated to cancelled. Not supported on Instagram, TikTok, or Snapchat. Threaded posts delete all items. YouTube deletion is permanent. 
        /// </summary>
        /// <exception cref="Late.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="postId"></param>
        /// <param name="unpublishPostRequest"></param>
