...
namespace Zernio.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateStandaloneAd201ResponseOneOf" /> class.
        /// </summary>
        /// <param name="ad">ad.</param>
        /// <param name="message">message.</param>
        public CreateStandaloneAd201ResponseOneOf(Ad ad = default, string message = default)
        {
            this.Ad = ad;
